...
import InputSearch from '../../../components/InputSearch/index.ts';
import { ErrorObject, JobDetails, PackageInfo } from "@excelcabinets/excel-types/LotTableInterface";
import InputError from '../../../components/InputError/component.tsx';
...
function JobPackageCreator() {
  ...
  return (
    <>
      <Modal modalType={modalType} turnOffModal={turnOffModal}>
        {modalType === "delete" ? 
